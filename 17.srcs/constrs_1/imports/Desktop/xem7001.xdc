...
set_property IOSTANDARD LVCMOS33 [get_ports {trig_in[11]}]

### JP2-12 
set_property PACKAGE_PIN K3 [get_ports {trig_in[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {trig_in[10]}]

### JP2-13 
set_property PACKAGE_PIN L3 [get_ports {trig_in[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {trig_in[9]}]

### JP2-14 
set_property PACKAGE_PIN M1 [get_ports {trig_in[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {trig_in[8]}]

### JP2-15 
set_property PACKAGE_PIN M2 [get_ports {trig_in[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {trig_in[7]}]

### JP2-16 
set_property PACKAGE_PIN L4 [get_ports {trig_in[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {trig_in[6]}]

### JP2-17 
set_property PACKAGE_PIN M4 [get_ports {trig_in[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {trig_in[5]}]

### JP2-18 
set_property PACKAGE_PIN N1 [get_ports {trig_in[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {trig_in[4]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {trig_in[3]}]

### JP2-22 
set_property PACKAGE_PIN N3 [get_ports {trig_in[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {trig_in[2]}]

### JP2-23 
set_property PACKAGE_PIN P1 [get_ports {trig_in[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {trig_in[1]}]

### JP2-24 
set_property PACKAGE_PIN R1 [get_ports {trig_in[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {trig_in[0]}]
